...
export const metadata = {
  title: 'Best Boutique Hotels for Solo Travelers in Split - BestTrips.org',
  description: 'Discover the best boutique hotels for solo travelers in Split, Croatia. Expert recommendations, local tips, and top picks for your perfect stay.'
}
...
const content = {
  ...
  whyChoose: [
    ...
    "For solo travelers, Split's boutique hotels provide the perfect balance of comfort and convenience. Many properties are strategically located near public transport, making it easy to explore the city's many attractions.",

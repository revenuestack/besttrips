...
export const metadata = {
  title: 'Best Villas for Groups in Tokyo - BestTrips.org',
  description: 'Discover the best villas for groups in Tokyo, Japan. Expert recommendations, local tips, and top picks for your perfect stay.'
}
...
const content = {
  ...
  whyChoose: [
    ...
    "For groups, Tokyo's villas provide the perfect balance of comfort and convenience. Many properties are strategically located near public transport, making it easy to explore the city's many attractions.",

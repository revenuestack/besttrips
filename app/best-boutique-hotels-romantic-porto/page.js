...
export const metadata = {
  title: 'Best Boutique Hotels for Romantic Getaways in Porto - BestTrips.org',
  description: 'Discover the best boutique hotels for romantic getaways in Porto, Portugal. Expert recommendations, local tips, and top picks for your perfect stay.'
}
...
const content = {
  ...
  whyChoose: [
    ...
    "For romantic getaways, Porto's boutique hotels provide the perfect balance of comfort and convenience. Many properties are strategically located near public transport, making it easy to explore the city's many attractions.",

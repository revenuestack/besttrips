...
export const metadata = {
  title: 'Best Villas for Seniors in Marrakech - BestTrips.org',
  description: 'Discover the best villas for seniors in Marrakech, Morocco. Expert recommendations, local tips, and top picks for your perfect stay.'
}
...
const content = {
  ...
  whyChoose: [
    ...
    "For seniors, Marrakech's villas provide the perfect balance of comfort and convenience. Many properties are strategically located near public transport, making it easy to explore the city's many attractions.",

...
export const metadata = {
  title: 'Best Hotels for Groups in Florence - BestTrips.org',
  description: 'Discover the best hotels for groups in Florence, Italy. Expert recommendations, local tips, and top picks for your perfect stay.'
}
...
const content = {
  ...
  whyChoose: [
    ...
    "For groups, Florence's hotels provide the perfect balance of comfort and convenience. Many properties are strategically located near public transport, making it easy to explore the city's many attractions.",

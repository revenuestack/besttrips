...
export const metadata = {
  title: 'Best Hostels for Romantic Getaways in Florence - BestTrips.org',
  description: 'Discover the best hostels for romantic getaways in Florence, Italy. Expert recommendations, local tips, and top picks for your perfect stay.'
}
...
const content = {
  ...
  whyChoose: [
    ...
    "For romantic getaways, Florence's hostels provide the perfect balance of comfort and convenience. Many properties are strategically located near public transport, making it easy to explore the city's many attractions.",

...
export const metadata = {
  title: 'Best Boutique Hotels for Groups in Copenhagen - BestTrips.org',
  description: 'Discover the best boutique hotels for groups in Copenhagen, Denmark. Expert recommendations, local tips, and top picks for your perfect stay.'
}
...
const content = {
  ...
  whyChoose: [
    ...
    "For groups, Copenhagen's boutique hotels provide the perfect balance of comfort and convenience. Many properties are strategically located near public transport, making it easy to explore the city's many attractions.",

...
export const metadata = {
  title: 'Best Hotels for Families in Marrakech - BestTrips.org',
  description: 'Discover the best hotels for families in Marrakech, Morocco. Expert recommendations, local tips, and top picks for your perfect stay.'
}
...
const content = {
  ...
  whyChoose: [
    ...
    "For families, Marrakech's hotels provide the perfect balance of comfort and convenience. Many properties are strategically located near public transport, making it easy to explore the city's many attractions.",

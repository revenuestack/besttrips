...
export const metadata = {
  title: 'Best Hotels for Romantic Getaways in Sydney - BestTrips.org',
  description: 'Discover the best hotels for romantic getaways in Sydney, Australia. Expert recommendations, local tips, and top picks for your perfect stay.'
}
...
const content = {
  ...
  whyChoose: [
    ...
    "For romantic getaways, Sydney's hotels provide the perfect balance of comfort and convenience. Many properties are strategically located near public transport, making it easy to explore the city's many attractions.",

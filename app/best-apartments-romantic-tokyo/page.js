...
export const metadata = {
  title: 'Best Apartments for Romantic Getaways in Tokyo - BestTrips.org',
  description: 'Discover the best apartments for romantic getaways in Tokyo, Japan. Expert recommendations, local tips, and top picks for your perfect stay.'
}
...
const content = {
  ...
  whyChoose: [
    ...
    "For romantic getaways, Tokyo's apartments provide the perfect balance of comfort and convenience. Many properties are strategically located near public transport, making it easy to explore the city's many attractions.",
